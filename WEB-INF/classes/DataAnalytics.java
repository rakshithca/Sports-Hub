...
public class DataAnalytics extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		pw.print("<h1 class='mb-3 bread'>Data Analytics</h1>");
		pw.print("<p class='breadcrumbs'><span class='mr-2'><a href='Home'>Home <i class='ion-ios-arrow-forward'></i></a></span> <span>Datanalytics<i class='ion-ios-arrow-forward'></i></span></p></div></div></div>");
